...
void MotPaP::demiPas(int direction) {
    ...
    if(etapePas < 0) etapePas = 7;
    if(etapePas > 7) etapePas = 0;

    switch (etapePas) {
        case 0: phases = 0x1; break;  // 0001
        case 1: phases = 0x3; break;  // 0011
        case 2: phases = 0x2; break;  // 0010   
        case 3: phases = 0x6; break;  // 0110
        case 4: phases = 0x4; break;  // 0100
        case 5: phases = 0xC; break;  // 1100
        case 6: phases = 0x8; break;  // 1000
        case 7: phases = 0x9; break;  // 1001
        
        default: phases = 0x0; break; // 0000
    }
